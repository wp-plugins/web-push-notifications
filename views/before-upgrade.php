<div class="wrap">
    ...
    <a href="http://www.tidioelements.com/?utm_source=wordpress&utm_medium=cpc&utm_campaign=plugin_inside&utm_content=notification" id="tidio-top-logo"></a>

    <h2>Tidio Tidio Automation<a href="#" id="notification-settings-link" class="settings-link">settings</a></h2>
...
<script>
    ...
    (function () {
        ...
        uv.async = true;
        uv.src = '//widget.uservoice.com/D0pU3d20Ujw1JxjtZpriA.js';
